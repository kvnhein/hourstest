...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { abv: @beer.abv, brewery: @beer.brewery, details: @beer.details, name: @beer.name, price: @beer.price, serving: @beer.serving, type: @beer.type, venue_id: @beer.venue_id }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { abv: @beer.abv, brewery: @beer.brewery, details: @beer.details, name: @beer.name, price: @beer.price, serving: @beer.serving, type: @beer.type, venue_id: @beer.venue_id }
    assert_redirected_to beer_path(assigns(:beer))
  end
