...
class BrewsControllerTest < ActionController::TestCase
  ...
  test "should create brew" do
    assert_difference('Brew.count') do
      post :create, brew: { abv: @brew.abv, brewery: @brew.brewery, detail: @brew.detail, name: @brew.name }
    end
  ...
  test "should update brew" do
    patch :update, id: @brew, brew: { abv: @brew.abv, brewery: @brew.brewery, detail: @brew.detail, name: @brew.name }
    assert_redirected_to brew_path(assigns(:brew))
  end
